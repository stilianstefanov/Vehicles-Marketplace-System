...
namespace ThinkElectric.Data.Migrations
{
    ...
    [Migration("20230629102113_Initial")]
            ...
            modelBuilder.Entity("ThinkElectric.Data.Models.Order", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedOn")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 6, 29, 10, 21, 13, 351, DateTimeKind.Utc).AddTicks(9465));
            ...
            modelBuilder.Entity("ThinkElectric.Data.Models.Product", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedOn")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 6, 29, 10, 21, 13, 351, DateTimeKind.Utc).AddTicks(9806));
            ...
            modelBuilder.Entity("ThinkElectric.Data.Models.ApplicationUser", b =>
                {
                    ...
                    b.HasOne("ThinkElectric.Data.Models.Cart", "Cart")
                        .WithOne("User")
                        .HasForeignKey("ThinkElectric.Data.Models.ApplicationUser", "CartId");
